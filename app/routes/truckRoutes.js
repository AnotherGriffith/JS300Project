...
router.route('/')
	...
	// according to class review the code should be more like this instead of above.
	// want to send back the truck you get back from operation - it will have an id
